  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="流程编号" prop="soId">
        <el-input v-model="formData.soId" placeholder="请输入流程编号" />
      </el-form-item>
      <el-form-item label="调整金额" prop="amount">
        <el-input v-model="formData.amount" placeholder="请输入调整金额" />
      </el-form-item>
      ...
      <el-form-item label="调整账户" prop="account">
        <el-input v-model="formData.account" placeholder="请输入调整账户" />
      </el-form-item>
      ...
      <el-form-item label="调整后余额" prop="adjustBalance">
        <el-input v-model="formData.adjustBalance" placeholder="请输入调整后余额" />
      </el-form-item>
    </el-form>
    <template #footer>
...
/** 分销账户资金调整记录 表单 */
defineOptions({ name: 'AmountAdjForm' })
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value = await AmountAdjApi.getAmountAdj(id)
    } finally {
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as unknown as AmountAdjVO
    if (formType.value === 'create') {
      await AmountAdjApi.createAmountAdj(data)
      message.success(t('common.createSuccess'))
    } else {
      await AmountAdjApi.updateAmountAdj(data)
